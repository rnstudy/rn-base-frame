...
export default class Carousel extends Component {
    ...
    _calculateNextPage = direction => {
        ...
        const page =
            direction === "right" ? Math.ceil(ratio) : Math.floor(ratio);
        return this._normalizePageNumber(page);
    };
            ...
            <View style={styles.arrows} pointerEvents="box-none">
                <View
                    style={[
                        ...
                        this.props.arrowsContainerStyle
                    ]}
                    pointerEvents="box-none"
                >
                    <TouchableOpacity
    ...
    render() {
        ...
        return (
            <View {...containerProps}>
                    ...
                    contentContainerStyle={[
                        ...
                        this.props.contentContainerStyle,
                        {
                            width:
                                size.width *
                                (childrenLength +
                                    (childrenLength > 1 && this.props.isLooped
                                        ? 2
                                        : 0)),
                            height: size.height
                        }
                ...
                {this.props.arrows &&
                    this._renderArrows(this.state.childrenLength)}
                {this.props.bullets &&
                    this._renderBullets(this.state.childrenLength)}
                {this.props.pageInfo &&
                    this._renderPageInfo(this.state.childrenLength)}
            </View>
        );
    }
}
